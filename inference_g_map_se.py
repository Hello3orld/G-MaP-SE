...
from dataset import mag_pha_stft, mag_pha_istft, get_dataset_filelist
...
def inference(a):
    ...
    _, test_indexes = get_dataset_filelist(a)
    ...
    with torch.no_grad():
        for index in track(test_indexes):
            ...
            clean_wav, _ = librosa.load(os.path.join(a.input_clean_wavs_dir, index + '.wav'), sr=h.sampling_rate)
            ...
            amp_g, pha_g, com_g = model(noisy_wav, noisy_amp, noisy_pha)
